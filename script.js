...
// This javascript code is done with the collabration to our class mate Rafael and Yurong 
...
class ship  {
    ...
    //setting a Hull/Health value
    setHull(value){
        this.hull = value;
    };
    //setting a firePower value
    setFirePW(value){
        this.firePW = value;
    };
...
//Declaring a constatnt type value and assign the value of ship
const player = new ship('uss',defalutPlayerHull, 5, .7);

// Creating a function that will update the status of a player
...
// Creating a function that will update the status of alien ship
...
const alienFleet = [];// creating an array of alien fleet
const numberOfEnimeis = 6;

//creating a function to start a game
function gameStart(){
...
// to check how many aliens are left 
...
do{
    ...
    // a switch statement to check the game state 
